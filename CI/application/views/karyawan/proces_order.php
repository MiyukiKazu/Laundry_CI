...
<div class="col-md-12">
  ...
  <div class="card card-primary">
    <div class="card-header">
      <h3 class="card-title">Pesanan Diproses</h3>
    </div>  
    <table id="example2" class="table table-bordered table-hover">
      ...
      <tbody>
      <?php 
        $query = $this->db->query("SELECT * FROM detail_cucian,status_cucian WHERE  detail_cucian.id_statuscucian = status_cucian.id_statuscucian AND detail_cucian.id_statuscucian = 2 OR detail_cucian.id_statuscucian = status_cucian.id_statuscucian AND detail_cucian.id_statuscucian = 3 ORDER BY id_transaksi DESC");
